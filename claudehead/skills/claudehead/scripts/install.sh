#!/usr/bin/env bash
# Install claudehead from this plugin: link the wrapper into ~/.local/bin and make
...
NAME="claudehead"
CLIENT="claude"
CLIENT_HINT="https://docs.claude.com/en/docs/claude-code"

BIN_DIR="${CLAUDEHEAD_BIN_DIR:-$HOME/.local/bin}"
